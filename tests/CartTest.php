...
namespace Shahadat\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Shahadat\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Shahadat\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Shahadat\Shoppingcart\ShoppingcartServiceProvider;
use Shahadat\Tests\Shoppingcart\Fixtures\ProductModel;
use Shahadat\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Shahadat\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Shahadat\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Shahadat\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \Shahadat\Shoppingcart\Cart
     */
